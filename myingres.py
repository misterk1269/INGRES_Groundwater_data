...
class INGRESChatBot:
    ...
    def _train_models(self):
        ...
        try:
            ...
            self.scalers['extraction'] = StandardScaler()   # ✅ dict me save
            ...
            print(f"✅ Extraction Model R²: {model1.score(X1_scaled, y1):.3f}")
        except Exception:
        ...
        try:
            ...
            self.scalers['category'] = StandardScaler()   # ✅ dict me save
        ...
        if errors:
            print(f"❌ Error training models: {errors}")
...
def initialize_ingres_chatbot():
    ...
    print("🤖 Initializing INGRES AI ChatBot...")
    print("=" * 50)
...
def demo_chatbot_features(chatbot):
    ...
    if isinstance(state_analysis, dict):
        print(f"🏛️ Gujarat Analysis: {state_analysis['data_analysis']}")
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 50)
    print("🎉 INGRES AI ChatBot is ready!")
